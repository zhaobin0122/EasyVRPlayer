...
public class Pvr_ControllerDemo : MonoBehaviour
{
        ...
        if (HeadSetController.activeSelf)
        {
            ...
            else
            {
                ...
                if (Pvr_ControllerManager.Instance.LengthAdaptiveRay)
                {
                    ...
                    //HeadSetController.transform.localScale = new Vector3(0.004f, 0.004f, 1);
                }
            }
            ...
            if (currentController != null)
            {
                ...
                else
                {
                    ...
                    if(Pvr_ControllerManager.Instance.LengthAdaptiveRay)
                    {
                        ...
                        Vector3 dotPosition = currentController.transform.position + currentController.transform.forward.normalized * (0.5f + rayDefaultLength);
                        int deviceType = Controller.UPvr_GetDeviceType();
                        if (deviceType == 4)
                        {
                         
                        }
                        currentController.transform.Find("dot").position = dotPosition;
                    }
                }
            }
    ...
    private void ServiceStartSuccess()
    {
        ...
        if (Controller.UPvr_GetMainHandNess() == 0)
        {
            ...
            controller0.transform.Find("controller/ModelRoot").gameObject.SetActive(true);
            controller1.transform.Find("controller/ModelRoot").gameObject.SetActive(false);
        }
        if (Controller.UPvr_GetMainHandNess() == 1)
        {
            currentController = controller1;
            controller0.transform.Find("controller/ModelRoot").gameObject.SetActive(false);
            controller1.transform.Find("controller/ModelRoot").gameObject.SetActive(true);
        }
    }
