...
public class NoloVR_GraphicRaycaster : GraphicRaycaster
{
    ...
    private GraphicRaycaster defaultRaycaster;

    private void Update()
    {
        //if (defaultRaycaster != null && defaultRaycaster.enabled && (NoloVR_Plugins.GetElectricity(1) != 0 || NoloVR_Plugins.GetElectricity(2) != 0))
        //{
    ...
    protected override void OnEnable()
    {
        ...
        defaultRaycaster = canvas.gameObject.GetComponent<GraphicRaycaster>();
